...
const ledger: GaugeReviewLedgerArtifact = {
  ...
  reviews: [
    { key: 'usgs:1', status: 'covered', eligibility: 'route_capable', relationship: 'direct', checkedAt: '2026-08-14T00:00:00.000Z', decisionReason: 'Covered', decisionSource: 'manual', routeSlugs: ['route'], scoredRouteSlugs: ['route'], routeFamilies: ['river'], blockers: [], evidence: [] },
    { key: 'usgs:2', status: 'blocked', eligibility: 'route_capable', relationship: 'none', checkedAt: '2026-08-14T00:00:00.000Z', decisionReason: 'No access', decisionSource: 'manual', routeSlugs: [], scoredRouteSlugs: [], routeFamilies: [], blockers: ['access'], evidence: [] },
    { key: 'usgs:3', status: 'screened_out', eligibility: 'not_paddle_relevant', relationship: 'none', checkedAt: '2026-08-14T00:00:00.000Z', decisionReason: 'Reservoir only', decisionSource: 'manual', routeSlugs: [], scoredRouteSlugs: [], routeFamilies: [], blockers: [], evidence: [] },
  ],
};
