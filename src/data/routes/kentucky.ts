...
export const kentuckyRoutes: River[] = [
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Treat the 7.3-mile Fisherville-to-Seaton Valley chain as Class I+ moving water with waves, root wads, shoals, and storm wood, not as a flatwater park float.",
        "Use only the KDFWR-listed Fisherville and Seaton Valley carry-downs, and follow the Parklands marked-landings-only and private-property rules.",
        "Stay inside the KDFWR 50 to 300 cfs good band unless the group is ready for faster current, fewer easy eddies, and a longer scrape-or-swim recovery."
      ],
      "reviewStatus": "reviewed"
    },
    "gaugeSource": {
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Use only the KDFWR-listed Cane Run and Seaton Valley carry-downs, and follow the Parklands marked-landings-only rule.",
        "Stay inside the KDFWR 50 to 300 cfs good band unless the group is ready for faster Class I+ current, waves, and fewer recovery eddies.",
        "Check recent rain and gauge trend before launching because Floyds Fork can rise quickly and collect fresh wood in bends and shoals."
      ],
      "reviewStatus": "reviewed"
    },
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Use only the KDFWR-listed Cane Run and Broad Run Valley carry-downs, and follow the Parklands marked-landings-only rule.",
        "Stay inside the KDFWR 50 to 300 cfs good band unless the group is ready for faster Class I+ current, waves, and fewer recovery eddies.",
        "Watch for strainers, bedrock shoals, undercut banks, and the Marys Island split; the lower-corridor guide tells paddlers to stay left there."
      ],
      "reviewStatus": "reviewed"
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Treat the 13.7-mile route as a long Class I+ moving-water day with The Oxbow, bridge current, wood, and fewer easy bailout options than the short Parklands segments.",
        "Stay inside KDFWR's 50 to 300 cfs good band unless the group is ready for stronger post-rain current, quick bends, and fewer recovery spots.",
        "Use only the KDFWR-listed North Beckley and Seaton Valley carry-downs, inspect the take-out before launching, and follow the Parklands marked-landings-only rule."
      ],
      "reviewStatus": "reviewed"
    },
    "gaugeSource": {
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Expect Class I+ moving water, shallow bedrock rapids, strainers, bluff-side current, and the Marys Island split where the lower-corridor guide says to stay left.",
        "Check recent rain, gauge trend, and visible current before launching because Floyds Fork can rise quickly and collect fresh wood in lower bends.",
        "Use only the Seaton Valley and Broad Run Valley carry-downs; The Parklands marked-landings-only rule leaves little room for casual private-bank exits."
      ],
      "reviewStatus": "reviewed"
    },
    "gaugeSource": {
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Plan for Class I+ moving water, the Marys Island split, bedrock shelves, strainers, and changing current through the lower Parklands corridor.",
        "Use the Fisherville gauge conservatively: KDFWR's good band is 50 to 300 cfs or 1.3 to 2.5 ft, and higher water reduces easy recovery options.",
        "Walk the Cliffside take-out before launch and use only marked KDFWR/Parklands landings, since private-bank or managed-boundary exits are not verified."
      ],
      "reviewStatus": "reviewed"
    },
    "gaugeSource": {
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Treat this as a long Parklands commitment with Class I+ current, shallow braided chutes, strainers, bridge current, and fatigue pressure.",
        "Use only the KDFWR-listed North Beckley and Broad Run Valley carry-downs; The Parklands says to use marked landings only and not private banks.",
        "Confirm the Fisherville gauge, rain trend, and visible launch conditions before committing, then watch for The Oxbow choices, the Cane Run side-channel zone, and Marys Island downstream."
      ],
      "reviewStatus": "reviewed"
    },
    "gaugeSource": {
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Treat this as an extended lower-Parklands commitment, use only the KDFWR-listed Fisherville and Cliffside carry-downs, and follow the marked-landings-only rule.",
        "Stay inside the KDFWR 50 to 300 cfs good band unless the group is ready for faster Class I+ current, long recovery swims, and fewer easy eddies.",
        "Watch for the signed Cane Run side-channel area, strainers, bedrock shoals, undercut banks, and the Marys Island split where the lower-corridor guide says to stay left."
      ],
      "reviewStatus": "reviewed"
    },
    "gaugeSource": {
  ...
  },
  {
    ...
    "safetyProfile": {
      ...
      "safetyNotes": [
        "Use only the KDFWR-listed Cane Run and Cliffside carry-downs, and follow the Parklands marked-landings-only rule.",
        "Stay inside the KDFWR 50 to 300 cfs good band unless the group is ready for faster Class I+ current, waves, and fewer recovery eddies.",
        "Watch for strainers, bedrock shoals, undercut banks, and the Marys Island split; the lower-corridor guide tells paddlers to stay left there."
      ],
      "reviewStatus": "reviewed"
