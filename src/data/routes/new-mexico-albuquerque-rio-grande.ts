...
const calabacillas = { name: 'Calabacillas Arroyo public river access (parking-area anchor)', latitude: 35.187115971800154, longitude: -106.65177189116153 };
const central = { name: 'Central Avenue public river access (parking-area anchor)', latitude: 35.08728077195977, longitude: -106.68221819147834 };
const rioBravo = { name: 'Rio Bravo Boulevard public river access (access-area anchor)', latitude: 35.0274595846295, longitude: -106.67462218892496 };
...
function makeRoute(spec: { id: string; reach: string; putIn: River['putIn']; takeOut: River['takeOut']; miles: number; summary: string; time: string; note: string; watch?: string[] }): River {
  return {
    ...
    evidenceNotes: [
      { label: 'Public access chain', value: spec.reach, note: 'The City of Albuquerque names the public boating access areas and describes legal non-motorized boating in the Albuquerque reach. Quiet Waters publishes access-area GPS references; the coordinates are parking/access anchors, not surveyed water-entry toes. Confirm the carry and current river landing before unloading.', sourceUrl: cityGuide.url },
...
export const newMexicoAlbuquerqueRioGrandeRoutes: River[] = [
  makeRoute({ id: 'rio-grande-calabacillas-central', reach: 'Calabacillas Arroyo access to Central Avenue access', putIn: calabacillas, takeOut: central, miles: 7.5, summary: 'A popular northern Rio Grande Valley State Park day reach from the Calabacillas access to Central Avenue, below the San Juan-Chama diversion hazard.', time: 'Allow 2–3 hours of river time plus carries, scouting and shuttle margin', note: 'Quiet Waters identifies Calabacillas as the preferred departure below the Alameda diversion. The City confirms both access areas and the calm-water character. These coordinates mark access/parking areas; carry to the river and inspect the current landing before unloading.', watch: ['Shallow braided channels and sandbars', 'Cold water and 25 mph wind threshold', 'Central Avenue bridge turbulence and limited parking'] }),
  makeRoute({ id: 'rio-grande-central-rio-bravo', reach: 'Central Avenue access to Rio Bravo Boulevard access', putIn: central, takeOut: rioBravo, miles: 5.5, summary: 'A southern Rio Grande Valley State Park float from Central Avenue through the Albuquerque bosque to the Rio Bravo public access.', time: 'Allow 1–2 hours of river time plus carries, scouting and shuttle margin', note: 'The City names both Central Avenue and Rio Bravo as public boating access areas. The Central Avenue coordinate marks the parking/access area reached from Sunset Road SW; carry boats from the lot to the river and confirm the current landing and carry conditions. Rio Bravo uses the northwest-bank launch area, separate from the northeast Poco Loco picnic and fishing site; verify the west-bank gate, launch and carry are open during bridge replacement before staging.', watch: ['Shallow water, wood and changing sandbars', 'Bridge turbulence and private-bank boundaries', 'Rio Bravo park hours, bridge construction and take-out carry'] }),
  makeRoute({ id: 'rio-grande-calabacillas-rio-bravo', reach: 'Calabacillas Arroyo access to Rio Bravo Boulevard access', putIn: calabacillas, takeOut: rioBravo, miles: 13, summary: 'The full Albuquerque Rio Grande Valley State Park day reach linking the Calabacillas, Central Avenue and Rio Bravo access chain.', time: 'Allow 3.5–5 hours of river time plus carries, breaks, scouting and shuttle margin', note: 'Quiet Waters describes the Calabacillas-to-Rio Bravo full run as a higher-flow option, while the City confirms the public access chain and the 400–500 cfs feasibility cue. The Rio Bravo endpoint is the northwest-bank emergency launch/access area in the bridge replacement project footprint; verify the west-bank gate, launch and carry are open before staging. Use Central Avenue as a contingency only after confirming its landing.', watch: ['Long carry and limited emergency vehicle access', 'Shallow braided channels, strainers and cold water', 'Rio Bravo park hours, bridge construction, wind and southern boundary conditions'] }),
];
