...
import { mississippiPascagoulaRoutes } from './routes/mississippi-pascagoula';
import { montanaClarkForkRoutes } from './routes/montana-clark-fork';
import { montanaBlackfootRoutes } from './routes/montana-blackfoot';
import { montanaBitterrootRoutes } from './routes/montana-bitterroot';
...
import { vermontOtterCreekRoutes } from './routes/vermont-otter-creek';
...
const stateRoutes: River[] = [
  ...
  ...californiaRussianExpansionRoutes,
  ...
  ...massachusettsHoosicRoutes,
  ...massachusettsHousatonicExpansionRoutes,
  ...mississippiBlackCreekRoutes,
  ...mississippiLeafRoutes,
  ...mississippiPascagoulaRoutes,
  ...montanaClarkForkRoutes,
  ...montanaBlackfootRoutes,
  ...montanaBitterrootRoutes,
  ...nevadaColoradoBlackCanyonRoutes,
  ...nevadaTruckeeRoutes,
  ...nevadaTruckeeExpansionRoutes,
  ...nevadaCarsonRoutes,
  ...nevadaEastForkCarsonRoutes,
  ...nevadaWalkerRoutes,
  ...
  ...newHampshireMerrimackRoutes,
  ...newHampshireMerrimackExpansionRoutes,
  ...newHampshireMerrimackFranklinExpansionRoutes,
  ...
  ...washingtonSpokaneExpansionRoutes,
  ...massachusettsConnecticutTurnersRoutes,
  ...massachusettsQuaboagRoutes,
  ...massachusettsWareExpansionRoutes,
  ...alabamaFlintRoutes,
  ...alabamaSipseyRoutes,
  ...
  ...alabamaBartramRoutes,
  ...alabamaTerrapinAutaugaRoutes,
  ...arizonaVerdeExpansionRoutes,
  ...floridaRoutes,
...
// Keep the source route cards discoverable, but enforce one publication rule
// at the catalog boundary: any explicitly Class IV+ reach is planning-only or
// hidden from live scoring in every state.
stateRoutes.forEach(enforceHighConsequencePlanning);
...
const routeOrder = [
  ...
  ...southCarolinaBlackRoutes.map(route => route.id),
  ...
  ...californiaRussianExpansionRoutes.map(route => route.id),
  ...
  ...massachusettsHoosicRoutes.map(route => route.id),
  ...massachusettsHousatonicExpansionRoutes.map(route => route.id),
  ...mississippiBlackCreekRoutes.map(route => route.id),
  ...mississippiLeafRoutes.map(route => route.id),
  ...mississippiPascagoulaRoutes.map(route => route.id),
  ...montanaClarkForkRoutes.map(route => route.id),
  ...montanaBlackfootRoutes.map(route => route.id),
  ...montanaBitterrootRoutes.map(route => route.id),
  ...
  ...nevadaEastForkCarsonRoutes.map(route => route.id),
  ...
  ...newHampshireMerrimackRoutes.map(route => route.id),
  ...newHampshireMerrimackExpansionRoutes.map(route => route.id),
  ...newHampshireMerrimackFranklinExpansionRoutes.map(route => route.id),
  ...
  ...vermontOtterCreekRoutes.map(route => route.id),
  ...
  ...washingtonSpokaneExpansionRoutes.map(route => route.id),
  ...massachusettsConnecticutTurnersRoutes.map(route => route.id),
  ...massachusettsQuaboagRoutes.map(route => route.id),
  ...massachusettsWareExpansionRoutes.map(route => route.id),
  ...
  ...alabamaBartramRoutes.map(route => route.id),
  ...alabamaTerrapinAutaugaRoutes.map(route => route.id),
  ...arizonaVerdeExpansionRoutes.map(route => route.id),
  ...
  "gunnison-river-chukar-gunnison-forks",
  "yampa-river-hayden-pump-station-headquarters",
  "yampa-river-headquarters-dorsey",
  "yampa-river-golf-course-loudy-simpson",
  "yampa-river-loudy-simpson-south-beach",
  "yampa-river-duffy-mountain-juniper-canyon",
  "yampa-river-juniper-canyon-maybell-bridge",
  ...
  "wv-cheat-hannahsville-riverview",
  ...
  "jackson-river-indian-draft-interstate",
  "jackson-river-fort-young-teddy-dressler",
  "cowpasture-river-sharon-evans",
  "rivanna-river-crofton-palmyra",
  "nottoway-river-double-bridge-route630",
  "reed-creek-kents-millers-blueway",
  "chestnut-creek-galax-byllesby",
  ...
  "smith-river-philpott-bassett",
  "smith-river-bassett-great-road",
  "smith-river-great-road-fieldale",
  "clinch-river-blackford-pucketts-hole",
  "south-fork-holston-route58-alvarado",
  ...
  "north-fork-holston-wadlow-yuma",
  "dan-river-danville-riverfront-anglers",
  "banister-river-kings-bridge-terrys",
  "pigg-river-waid-lynch",
  ...
  "roanoke-river-williamston-astoria",
  ...
  "new-river-todd-wagoner",
  "new-river-nc88-wagoner",
  "new-river-elk-shoals-wagoner",
  "new-river-wagoner-us221",
  "new-river-us221-kings-creek",
  "new-river-kings-creek-alleghany",
  "hammocks-beach-huggins-island-loop",
  "lumber-river-boardman-princess-ann",
  "south-fork-catawba-spencer-mcadenville",
  "south-fork-catawba-mcadenville-cramerton",
  "cape-fear-river-raven-rock-lillington",
  "tuckasegee-river-dillsboro-barkers-creek",
  "valley-river-andrews-tomotla",
  "uwharrie-river-low-water-bridge-hwy-109",
  "yadkin-river-us64-boones-cave",
...
"saranac-river-imperial-mill-lake-champlain",
  ...
  "illinois-river-watts-chewey",
  "lower-mountain-fork-reregulation-dam-us70",
  "flint-creek-us412-chewey",
  "blue-river-hwy7-cheadle-falls",
  ...
  "fall-river-cave-falls-concrete",
  ...
  "middle-fork-salmon-marsh-boundary",
  ...
  "north-fork-payette-mccall-hartsell",
  ...
  "crooked-fork-highway-12-white-sands",
  ...
  "north-fork-clearwater-elizabeth-kelly",
  "north-fork-clearwater-black-canyon",
  "north-fork-clearwater-washington-quartz",
  "north-fork-clearwater-weitas-washington",
  "north-fork-clearwater-hidden-kelly",
  ...
  "lolo-creek-cottonwood-lolo-road",
  "lolo-creek-lolo-road-greer",
  "bruneau-indian-hot-springs-bruneau",
  "west-fork-bruneau-rowland-indian-hot-springs",
  ...
  "priest-river-dickensheet-white-tail",
  "priest-river-mcabee-mudhole",
  "priest-river-outlet-dickensheet",
  "north-fork-st-joe-loop-creek-confluence",
  "big-creek-st-joe-end-road-bridge",
  "big-creek-middle-fork-airstrip-cache-bar",
  "st-joe-spruce-tree-gold-creek",
  "slate-creek-franklin-mine-st-joe",
  "marble-creek-camp-3-st-joe",
  "st-joe-tumbledown-gold-bluff",
  "south-fork-payette-grandjean-deadwood",
  "deadwood-river-julie-creek-deadwood-campground",
  "deadwood-river-upper-reservoir-julie",
  ...
  "teton-river-upper-fox-creek-highway-33",
  "teton-river-dam-site-teton-forks",
  "teton-river-lower-canyon",
  "teton-river-highway-33-spring-hollow",
  "pine-creek-north-fork-highway-21-snake",
  "bitch-creek-coyote-meadows-highway-32",
  ...
  "st-joe-river-bluff-turner-flat",
  "st-joe-river-spruce-tree-turner-flat",
  "pack-river-upper-grottos",
  "pack-river-upper-slides",
  "pack-river-upper-gorgette",
  "south-fork-coeur-dalene-mullan-wallace",
  "st-maries-river-mashburn-st-joe",
  ...
  "smith-creek-upper",
  "smith-creek-bridge-smith-falls",
