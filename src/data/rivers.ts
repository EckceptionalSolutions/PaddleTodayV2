...
export const rivers: River[] = [
  ...
  {
    id: 'wolf-river-markton-big-smokey-falls',
    slug: 'wolf-river-markton-big-smokey-falls',
    name: 'Wolf River',
    reach: 'Markton County M Landing to Big Smokey Falls Landing',
    state: 'Wisconsin',
    region: 'Northwoods Wisconsin',
    summary:
      'Advanced Wolf River Section IV run through Menominee Tribal lands, with County M access, the Dalles Gorge, Big Smokey Falls, multiple Class III drops, a Class IV finish, and a full Langlade-gauge flow ladder.',
    statusText:
      'Use the Wolf River at Langlade gauge. Treat 400 to 700 cfs as the best broad target, 250 to 400 cfs as low runnable and bony, 700 to 1,000 cfs as advanced pushy water, and 1,000+ cfs as big-water Class IV territory beyond the app recommendation.',
    latitude: 45.12518,
    longitude: -88.66322,
    routeType: 'whitewater',
    gaugeSource: {
    ...
    profile: {
      ...
      tooHigh: 1000,
      thresholdSource: {
        label: 'Wisconsin Trail Guide Wolf River Markton-to-Big Smokey Falls flow bands',
        url: 'https://wisconsintrailguide.com/2024/paddle/wolf-river-markton.html',
        provider: 'wisconsin_trail_guide',
      },
      thresholdSourceStrength: 'community',
      rainfallSensitivity: 'medium',
      seasonMonths: [5, 6, 7, 8, 9],
      seasonNotes:
        'The Wolf is spring-fed enough to run through much of the warm season, but dry spells make Shotgun Eddy and Pismire bony. Sustained rain can leave this section good-to-excellent for a while, but high water raises hydraulics and strainer consequence quickly.',
      difficulty: 'hard',
      difficultyNotes:
        'Advanced whitewater only. Wisconsin Trail Guide lists Class III-IV features including Gilmore\'s Mistake, Pismire Falls, Sullivan Falls, Duck\'s Nest, Lower Dells, and Big Smokey Falls. Scout, portage, or use a licensed local outfitter if you are not fully comfortable with Class III-IV whitewater.',
      confidenceNotes:
        'Confidence is high for a guarded expert-only add: Wisconsin Trail Guide documents the exact Markton County M-to-Big Smokey Falls route, WGS84 endpoint coordinates, access requirements, hazards, and a full Langlade-gauge ladder; USGS operates the same-river Langlade gauge 9.5 miles upstream; and American Whitewater corroborates the Otter Slide-to-Big Smokey Section IV gauge pairing. The route is intentionally narrow-audience because it crosses Menominee Tribal lands and requires a pass or outfitter arrangement.',
    },
    evidenceNotes: [
      {
        label: 'Route-specific bands',
        value: '400-700 cfs very good range',
        note: 'Wisconsin Trail Guide treats below 250 cfs as not recommended, 250-400 cfs as low runnable, 400-700 cfs as very good, 700-1,000 cfs as advanced challenging water, 1,000-1,500 cfs as high Class IV, and 1,500+ cfs as rare extreme water.',
        sourceUrl: 'https://wisconsintrailguide.com/2024/paddle/wolf-river-markton.html',
      },
      {
        label: 'Same-river gauge',
        value: 'USGS 04074950',
        note: 'Wisconsin Trail Guide says the Langlade gauge is about 9.5 miles upstream of this segment and should accurately indicate current conditions on the reach.',
        sourceUrl: 'https://waterdata.usgs.gov/monitoring-location/USGS-04074950/',
      },
      {
        label: 'Endpoint coordinates',
        value: 'County M 45.12518, -88.66322; Big Smokey 45.01644, -88.63758',
        note: 'Wisconsin Trail Guide publishes NAD83 / WGS84 GPS points for County M DNR Landing and Big Smokey Falls Landing on the W6 guide.',
        sourceUrl: 'https://wisconsintrailguide.com/2024/paddle/pdf/guide-wolf6.pdf',
      },
      {
        label: 'Access requirement',
        value: 'Menominee pass required',
        note: 'Wisconsin Trail Guide states that paddlers must obtain a Menominee Indian Tribe pass through Big Smokey Falls Rafting or Shotgun Eddy Campground and Rafting before paddling this tribal-lands section.',
        sourceUrl: 'https://wisconsintrailguide.com/2024/paddle/pdf/guide-wolf6.pdf',
      },
      {
        label: 'Route character',
        value: '12.7 miles; Class III-IV',
        note: 'Wisconsin Trail Guide lists the Markton-to-Big Smokey Falls run as 12.7 miles, 5 to 6 hours by kayak/canoe, 179 feet of drop, and Class IV as the most difficult whitewater.',
        sourceUrl: 'https://wisconsintrailguide.com/2024/paddle/pdf/guide-wolf6.pdf',
      },
      {
        label: 'Whitewater corroboration',
        value: 'AW Section IV',
        note: 'American Whitewater documents the Wolf Otter Slide-to-Big Smokey Falls Section IV reach and ties it to the Wolf River at Langlade gauge.',
        sourceUrl: 'https://www.americanwhitewater.org/content/River/view/river-detail/2316/main',
      },
    ],
    sourceLinks: [
      {
        label: 'Wisconsin Trail Guide Wolf River Markton to Big Smokey Falls',
        url: 'https://wisconsintrailguide.com/2024/paddle/wolf-river-markton.html',
        provider: 'wisconsin_trail_guide',
      },
      {
        label: 'Wisconsin Trail Guide Wolf W6 PDF',
        url: 'https://wisconsintrailguide.com/2024/paddle/pdf/guide-wolf6.pdf',
        provider: 'wisconsin_trail_guide',
      },
      {
        label: 'USGS 04074950 Wolf River at Langlade',
      ...
      {
        label: 'American Whitewater Wolf Section IV',
        url: 'https://www.americanwhitewater.org/content/River/view/river-detail/2316/main',
        provider: 'american_whitewater',
      },
      {
        label: 'Rivers.gov Wolf River',
        url: 'https://www.rivers.gov/river/wolf',
        provider: 'local',
      },
    ],
  },
  ...
  {
    id: 'upper-iowa-river-cattle-creek-bluffton',
    slug: 'upper-iowa-river-cattle-creek-bluffton',
    name: 'Upper Iowa River',
    reach: 'Cattle Creek Road to Bluffton Fir Stand Access',
    state: 'Iowa',
    region: 'Northeast Iowa',
    summary:
      'Signature Bluffton-area Upper Iowa run through Chimney Rock, Bluffton Palisades, clear riffles, and busy summer outfitter country, with a same-corridor Bluffton gauge and route-specific flow guidance.',
    statusText:
      'Use the Upper Iowa River at Bluffton gauge. Treat roughly 200 to 500 cfs as the best broad window, 150 cfs as scrape-prone, and 700+ cfs as too pushy for a normal recreational recommendation.',
    latitude: 43.4149,
    longitude: -91.95874,
    gaugeSource: {
      id: 'usgs-05387440',
    ...
    profile: {
      ...
      seasonMonths: [4, 5, 6, 7, 8, 9, 10],
      seasonNotes:
        'Spring through fall can work, but the best clarity and easiest decision-making tend to come at lower-to-moderate flows. Summer weekends are busy, and rain can make this shallow, clear river pushy quickly.',
      difficulty: 'easy',
      difficultyNotes:
        'Mostly easy riffles and swift current at normal levels. Treat higher flows, cold water, crowded accesses, private campground traffic, and any new wood as the main decision points.',
      confidenceNotes:
        'Confidence is good for an Iowa community-source add: the Upper Iowa River Paddler\'s Guide, developed with Iowa DNR Fisheries Bureau input, names Cattle Creek and Bluffton Fir Stand in the public-access sequence; Wisconsin River Trips documents the exact Cattle Creek Road-to-Bluffton Road / W20 route, access notes, hazards, and Bluffton-gauge water guidance; and USGS 05387440 is a direct same-river live gauge at Bluffton. Endpoint coordinates are anchored to public bridge/access context, but paddlers should still confirm current parking because the Cattle Creek bridge/access area has changed since older trip reports.',
    },
    evidenceNotes: [
      {
        label: 'Official access sequence',
        value: 'Cattle Creek to Bluffton Fir Stand Access',
        note: 'The Upper Iowa River Paddler\'s Guide lists the Kendallville-to-Bluffton segment access sequence and places Bluffton Fir Stand Access at river mile 73.4, downstream of Cattle Creek, Chimney Rock, and Bluffton Bluff Access.',
        sourceUrl: 'https://www.winneshiekwild.com/wp-content/uploads/2019/12/Upper-Iowa-River-Paddlers-Guide-Web.pdf',
      },
      {
        label: 'Published route report',
        value: 'Cattle Creek Road Bridge to Bluffton Road/W20 Canoe Ramp',
        note: 'Wisconsin River Trips documents this route as a 9.7-mile Upper Iowa trip and calls out the Cattle Creek Road put-in and public canoe launch just downstream from Bluffton Road / W20.',
        sourceUrl: 'https://www.wisconsinrivertrips.com/segments/upper-iowa-river',
      },
      {
        label: 'Target range',
        value: 'About 200 to 500 cfs',
        note: 'Wisconsin River Trips reports 305 cfs at Bluffton as more than plenty, treats 200 cfs as low, and says lower water favors clarity while still avoiding the scrape-heavy floor.',
        sourceUrl: 'https://www.wisconsinrivertrips.com/segments/upper-iowa-river',
      },
      {
        label: 'Low-water floor',
        value: '150 cfs',
        note: 'The same route report describes 150 cfs at Bluffton as scrape-prone, while noting paddlers still regularly run below that level.',
        sourceUrl: 'https://www.wisconsinrivertrips.com/segments/upper-iowa-river',
      },
      {
        label: 'High-water ceiling',
        value: '700+ cfs',
        note: 'Wisconsin River Trips estimates that 700 cfs and above on the Bluffton gauge would be too pushy for this route.',
        sourceUrl: 'https://www.wisconsinrivertrips.com/segments/upper-iowa-river',
      },
      {
        label: 'Direct gauge',
        value: 'USGS 05387440',
        note: 'USGS operates Upper Iowa River at Bluffton, IA, with current and historical observations in the same Bluffton route corridor.',
        sourceUrl: 'https://waterdata.usgs.gov/monitoring-location/USGS-05387440/',
      },
      {
        label: 'Put-in support',
        value: 'Cattle Creek Road / Daley Bridge access area',
        note: 'Wisconsin River Trips describes the Cattle Creek Road bridge as a busy access with roadside parking and a launch ramp, and The Gazette identifies the same area as Daley Bridge Canoe Access at Cattle Creek Road.',
        sourceUrl: 'https://www.thegazette.com/travel/an-oscar-winning-trip-down-the-upper-iowa-river/',
      },
      {
        label: 'Take-out support',
        value: 'Bluffton Fir Stand Access / Bluffton Road-W20 canoe ramp',
        note: 'The Upper Iowa River Paddler\'s Guide lists Bluffton Fir Stand Access and the route report describes a public canoe launch with parking just downstream from Bluffton Road / W20.',
        sourceUrl: 'https://www.wisconsinrivertrips.com/segments/upper-iowa-river',
      },
    ],
    sourceLinks: [
  ...
  },
  {
    ...
    name: 'Wisconsin River',
    reach: 'Muscoda Landing West to Woodman Landing',
    state: 'Wisconsin',
    region: 'Lower Wisconsin Riverway',
    summary:
      'Long, scenic Lower Wisconsin day or overnight from Muscoda to Woodman, with wooded islands, bluff-lined bends, and multiple intermediate public landings. It uses the direct Muscoda gauge and Wisconsin Trail Guide LWSR3 level ladder.',
    statusText:
      'Use the Muscoda gauge. Treat 4,000 to 10,000 cfs as the normal sandbar-friendly window, below about 2,500 cfs as too shallow for an app recommendation, 17,000 cfs and up as high-water day-trip only, and above 20,000 cfs as not recommended.',
    latitude: 43.198,
    longitude: -90.44576,
    ...
    profile: {
      ...
      tooHigh: 20000,
      thresholdSource: {
        label: 'Wisconsin Trail Guide LWSR3 Muscoda-gauge suggested river levels',
        url: 'https://wisconsintrailguide.com/2024/paddle/wisconsin-river-lower-muscoda.html',
        provider: 'wisconsin_trail_guide',
      },
      thresholdSourceStrength: 'mixed',
      rainfallSensitivity: 'medium',
      seasonMonths: [5, 6, 7, 8, 9, 10],
      seasonNotes:
        'Spring through fall is the normal season. For overnight plans, check upstream rain and possible river surges even when local weather looks quiet.',
      difficulty: 'moderate',
      difficultyNotes:
        'The route is flatwater, but 24.5 miles, broad-water wind, side-channel choices, fatigue, and overnight logistics make it more committed than a short Lower Wisconsin day trip.',
      confidenceNotes:
        'Confidence is strong for a guarded Lower Wisconsin add: Wisconsin Trail Guide documents the exact LWSR3 Muscoda-to-Woodman route, WGS84 endpoint coordinates, landing amenities, route character, and the Muscoda-gauge level ladder. Wisconsin DNR lists Muscoda west side of Highway 80 and Woodman Lake among major Lower Wisconsin public access points and names popular subroutes through Blue River and Boscobel. USGS operates the direct 05407000 Wisconsin River at Muscoda gauge at the put-in town.',
    },
    evidenceNotes: [
      {
        label: 'Exact guide route',
        value: 'Muscoda to Woodman, 24.5 miles',
        note: 'Wisconsin Trail Guide LWSR3 documents Muscoda Landing West to Woodman Landing as a 24.5-mile Lower Wisconsin route with flat water, 29 feet of drop, and a full-day or multi-day time estimate.',
        sourceUrl: 'https://wisconsintrailguide.com/2024/paddle/wisconsin-river-lower-muscoda.html',
      },
      {
        label: 'Direct live gauge',
        value: 'USGS 05407000',
        note: 'USGS identifies 05407000 as Wisconsin River at Muscoda, WI, with the site located at the put-in town and used by Wisconsin Trail Guide for LWSR3 level guidance.',
        sourceUrl: 'https://waterdata.usgs.gov/monitoring-location/USGS-05407000/',
      },
      {
        label: 'Published level bands',
        value: '4,000 to 10,000 cfs normal',
        note: 'Wisconsin Trail Guide LWSR3 lists below 4,000 cfs as very shallow, 4,000-10,000 cfs as normal summer conditions, 17,000-20,000 cfs as high day-trip-only water, and above 20,000 cfs as not recommended.',
        sourceUrl: 'https://wisconsintrailguide.com/paddle/pdf/guide-lwsr3.pdf',
      },
      {
        label: 'Endpoint coordinates',
        value: 'Muscoda 43.19800, -90.44576; Woodman 43.07699, -90.84597',
        note: 'Wisconsin Trail Guide LWSR3 PDF publishes NAD83 / WGS84 coordinates for Muscoda Landing West and Woodman Landing.',
        sourceUrl: 'https://wisconsintrailguide.com/paddle/pdf/guide-lwsr3.pdf',
      },
      {
        label: 'Public access support',
        value: 'DNR major access corridor',
        note: 'Wisconsin DNR lists Muscoda west side of Highway 80, Blue River Landing, Boscobel Landings, and Woodman Lake among major public access points on the Lower Wisconsin State Riverway.',
        sourceUrl: 'https://dnr.wisconsin.gov/topic/lands/lowerwisconsin/recreation/water',
      },
      {
        label: 'Route cautions',
        value: 'Islands, strainers, sandbar drop-offs',
        note: 'Wisconsin Trail Guide highlights island forks, narrow channels, strainers, strong current near sandbars, and reduced sandbar camping suitability as flows rise.',
        sourceUrl: 'https://wisconsintrailguide.com/2024/paddle/wisconsin-river-lower-muscoda.html',
      },
    ],
    sourceLinks: [
      {
        label: 'Wisconsin Trail Guide LWSR3',
        url: 'https://wisconsintrailguide.com/2024/paddle/wisconsin-river-lower-muscoda.html',
        provider: 'wisconsin_trail_guide',
      },
      {
        label: 'Wisconsin Trail Guide LWSR3 PDF',
        url: 'https://wisconsintrailguide.com/paddle/pdf/guide-lwsr3.pdf',
        provider: 'wisconsin_trail_guide',
      },
      {
        label: 'Wisconsin DNR Lower Wisconsin boating and canoeing',
  ...
  },
  {
    ...
    region: 'Northeast Iowa',
    summary:
      'Scenic Jackson County water-trail run from Canton through the Buzzard Ridge bluff corridor to Royertown, with clear gravel shallows, steady current, limestone scenery, and a direct Maquoketa gauge ladder.',
    statusText:
      'Use the Maquoketa River near Maquoketa gauge. Treat 701 to 1,000 cfs as the best target, below 500 cfs as too low for enjoyable paddling, and 2,001+ cfs as very high and pushy.',
    latitude: 42.16279,
    longitude: -90.891807,
    gaugeSource: {
      id: 'usgs-05418500',
  ...
  },
  {
    ...
    region: 'Northeast Iowa',
    summary:
      'Short Driftless Iowa run from the hidden Mederville landing to Littleport, with limestone outcrops, mostly undeveloped banks, quick Class I riffles, and a direct Littleport gauge ladder.',
    statusText:
      'Use the Volga River at Littleport gauge. Treat about 4.4 to 4.9 ft as the broad target, below 4.1 ft as too shallow, and 5.4+ ft as high enough for experienced paddlers only.',
    latitude: 42.7637267,
  ...
  },
  {
    ...
    region: 'Northeast Iowa',
    summary:
      'Popular Driftless Iowa water-trail run from downtown Elkader to Motor Mill, with wooded bluffs, frequent riffles, a historic mill finish, and a direct Elkader gauge ladder.',
    statusText:
      'Use the Turkey River above French Hollow Creek at Elkader gauge. Treat 251 to 450 cfs as the average target, 100 cfs as the low floor, and 1,501+ cfs as too high for a normal recreational recommendation.',
    latitude: 42.853356,
    longitude: -91.402402,
    gaugeSource: {
      id: 'usgs-05412020',
    ...
    profile: {
      ...
      seasonMonths: [4, 5, 6, 7, 8, 9, 10],
      seasonNotes:
        'Spring and fall are the most reliable scenic windows. The river is somewhat spring-fed and can hold up better than some nearby streams, but recent rain still changes clarity, riffle speed, and whitewater-park consequences quickly.',
      difficulty: 'moderate',
      difficultyNotes:
        'The downstream run is mostly Class I riffles at normal levels, but the optional whitewater-park ledges at the start are more consequential and should be scouted or bypassed by casual paddlers.',
      confidenceNotes:
        'Confidence is good for an Iowa community-source add: the Iowa DNR-backed Turkey River Water Trail names Elkader Access #39B to Motor Mill Access #32 as a 6.5-mile section, Wisconsin River Trips documents the same Elkader-to-Motor-Mill corridor and publishes a detailed Elkader-gauge ladder, and USGS 05412020 is a direct live gauge in Elkader. Endpoint confidence is strongest for the Elkader Whitewater Park put-in and good for Motor Mill through the official water-trail access name, Clayton County water-access page, and named map-feature coordinates.',
    },
    evidenceNotes: [
      {
        label: 'Official water-trail section',
  ...
  },
  {
    ...
    profile: {
      ...
      seasonMonths: [4, 5, 6, 7, 8, 9, 10],
      seasonNotes:
        'Spring and fall are best for scenery and stable clarity. Summer is popular but can be lower or more crowded; recent rain can raise the river quickly and reduce clarity.',
      difficulty: 'moderate',
      difficultyNotes:
        'Most rapids are Class I and beginner-suitable at normal levels, but this is a fast, coldwater stream with several strainers and high-water escalation toward Class II-style consequences.',
      confidenceNotes:
        'Confidence is good for a community-source add: Wisconsin River Trips documents the exact popular Volney-to-Sixteen route, provides a detailed Ion-gauge ladder, and gives access/hazard notes. Iowa DNR confirms public access, picnic facilities, rustic restroom, and carry-down boat launch context at Volney, while independent map sources identify Bridge Sixteen Canoe Access as the take-out.',
    },
    evidenceNotes: [
      {
        label: 'Route support',
  ...
  },
  {
    ...
    name: 'Turtle Creek',
    reach: 'East Creek Road to Highway 140',
    state: 'Wisconsin',
    region: 'South-Central Wisconsin',
    summary:
      'Clear southern-Wisconsin creek run from East Creek Road through the lower Turtle Creek Wildlife Area corridor to the Highway 140 access, with wild rice, gravel shallows, one easy Class I riffle, and a direct Carvers Rock Road gauge ladder.',
    statusText:
      'Use the Turtle Creek at Carvers Rock Road gauge. Treat about 101 to 250 cfs as the best broad window, 0 to 100 cfs as low but often paddleable, 251 to 350 cfs as high but navigable, and 501+ cfs as too high for enjoyable paddling.',
    latitude: 42.6113321,
    ...
    profile: {
      ...
      tooHigh: 501,
      thresholdSource: {
        label: 'Wisconsin River Trips Turtle Creek - East Creek Road gauge guidance',
        url: 'https://www.wisconsinrivertrips.com/segments/turtle-creek/east-creek-road',
        provider: 'wisconsin_river_trips',
      },
      thresholdSourceStrength: 'community',
      rainfallSensitivity: 'medium',
      seasonMonths: [4, 5, 6, 7, 8, 9, 10],
      seasonNotes:
        'Spring through fall is the practical window. Wisconsin DNR notes drought years can make Turtle Creek shallow and challenging, while Wisconsin River Trips says higher water starts to submerge the creek character and reduce clarity.',
      difficulty: 'easy',
      difficultyNotes:
        'Mostly easy swiftwater and quick current with one manageable Class I riffle below South Carvers Rock Road. The main risks are strainers after storms, aquatic weeds at low water, busy access areas, and cold water outside summer.',
      confidenceNotes:
    ...
    evidenceNotes: [
      {
        label: 'Route-specific guide',
        value: '6.8 miles; about 3 hours',
        note: 'Wisconsin River Trips publishes the East Creek Road to Highway 140 trip with distance, travel time, route character, and the East Creek/O Riley/Carvers Rock/Hwy 140 subreaches.',
        sourceUrl: 'https://www.wisconsinrivertrips.com/segments/turtle-creek/east-creek-road',
      },
      {
        label: 'Direct gauge',
        value: 'USGS 05431486',
        note: 'USGS operates Turtle Creek at Carvers Rock Road Near Clinton, WI, and Wisconsin River Trips uses this gauge for the exact East Creek Road route ladder.',
        sourceUrl: 'https://waterdata.usgs.gov/monitoring-location/USGS-05431486/',
      },
      {
        label: 'Gauge ladder',
        value: '101-250 cfs best broad window',
        note: 'Wisconsin River Trips says 101-150 cfs is a good clear-water depth, 151-250 cfs is decent, 251-350 cfs is still navigable but with submerged character, 351-500 cfs is high and less scenic, and 501+ cfs may be too high for enjoyable paddling.',
        sourceUrl: 'https://www.wisconsinrivertrips.com/segments/turtle-creek/east-creek-road',
      },
      {
        label: 'Public access context',
        value: 'Turtle Creek Wildlife Area',
        note: 'Wisconsin DNR says Turtle Creek Wildlife Area follows about 10 miles of Turtle Creek, has road crossings and parking lots, and offers primitive kayak and canoe launches.',
        sourceUrl: 'https://dnr.wisconsin.gov/topic/Lands/WildlifeAreas/turtlecreek',
      },
      {
        label: 'Endpoint coordinates',
        value: 'East Creek 42.6113321, -88.7804249; Hwy 140 42.5965016, -88.8637665',
        note: 'Wisconsin River Trips route and shuttle map context resolves the named East Creek Road put-in and Highway 140 take-out coordinates; DNR and WRT corroborate the public paddling/access corridor.',
        sourceUrl: 'https://www.wisconsinrivertrips.com/segments/turtle-creek/east-creek-road',
      },
      {
        label: 'Hazards',
    ...
    sourceLinks: [
      {
        label: 'Wisconsin River Trips Turtle Creek - East Creek Road',
        url: 'https://www.wisconsinrivertrips.com/segments/turtle-creek/east-creek-road',
        provider: 'wisconsin_river_trips',
      },
      {
        label: 'USGS 05431486 Turtle Creek at Carvers Rock Road',
        url: 'https://waterdata.usgs.gov/monitoring-location/USGS-05431486/',
        provider: 'usgs',
      },
      {
        label: 'Wisconsin DNR Turtle Creek Wildlife Area',
        url: 'https://dnr.wisconsin.gov/topic/Lands/WildlifeAreas/turtlecreek',
        provider: 'local',
      },
      {
        label: 'Wisconsin River Trips Turtle Creek overview',
        url: 'https://www.wisconsinrivertrips.com/segments/turtle-creek',
        provider: 'wisconsin_river_trips',
      },
      {
