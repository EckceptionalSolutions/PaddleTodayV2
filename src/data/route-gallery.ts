...
const approvedStateContextPhotos: Record<string, RouteGalleryPhoto> = {
  ...
  Massachusetts: {
    ...
    src: 'https://upload.wikimedia.org/wikipedia/commons/0/07/Deerfield_River_map_%28Massachusetts_%2B_Vermont%29.jpg?utm_source=commons.wikimedia.org&utm_campaign=imageinfo&utm_content=original',
    alt: 'A map of the Deerfield River system in Massachusetts and Vermont.',
    caption: 'Massachusetts river-system map context; not a route or current conditions image',
    credit: 'U.S. Geological Survey via Wikimedia Commons',
    takenLabel: 'Public domain; regional map context only',
  },
  Mississippi: {
