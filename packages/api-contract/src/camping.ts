...
const explicitNoCampingPattern =
  /do not assume .*camping|treat this as (?:a |an )?(?:short |long )?day (?:trip|run|route|float|paddle) unless camping is separately confirmed/i;
...
export function hasOvernightCampingSupport(
  classification: CampingClassification | null | undefined
) {
  return (
...
export function hasCampingSupport(
  classification: CampingClassification | null | undefined
) {
  return (
...
export function campingClassificationLabel(
  classification: CampingClassification | null | undefined
) {
  ...
  if (classification === 'on_route_campsite' || classification === 'overnight_capable') {
