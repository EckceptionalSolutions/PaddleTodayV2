...
The current catalog has 58 West Virginia route cards:
...
The research ledger has decisions for 30 priority gauges and 61 bounded route candidates across 14 corridors; all 61 have numeric threshold decisions and 56 currently advance. The Man and Logan stations support the Map 3/4 access-chain batch, Trip 17 adds a two-station Logan/Branchland handoff, the Great Cacapon station supports a three-reach lower-Cacapon batch, and the Elk River chain now includes public Queen Shoals–Clendenin North, Clendenin South–Blue Creek, and Blue Creek–Charleston floats. The WV gallery audit now finds approved, non-placeholder coverage for all 58 route cards by reusing same-river public-domain or attributed imagery where route-specific photography is unavailable.
...
**The lower Cacapon batch is now implemented** as `wv-cacapon-rt127-cacapon-crossing`, `wv-cacapon-cacapon-crossing-fishers-ford`, and `wv-cacapon-fishers-ford-power-plant`, using the WVDNR District 2 access chain and distances. The Great Cacapon stage gauge remains an explicit downstream proxy; the Fishers Ford reach preserves the WVDNR-marked dam portage boundary.
...
| 1D | **Implemented:** Queen Shoals DNR Access to Clendenin North DNR Access (`wv-elk-queen-shoals-clendenin-north`) | USGS 03197000, Elk River at Queen Shoals | Official water-trail pages identify the three-mile public float, public endpoint ownership, gate hours, paved Clendenin North ramp, and the closed Mink Shoals boundary. The product uses a conservative 4.5–8.0 ft local screen and retains the shallow-water/day-of visual gate. |
...
| 1F | **Implemented:** Clendenin South DNR Access to Blue Creek DNR Access (`wv-elk-clendenin-south-blue-creek`) | USGS 03197950, Elk River at Charleston | Official access pages identify the 5.4-mile pair and public DNR facilities. Charleston is a downstream proxy; use the conservative 300–8,000 cfs screen only with rainfall, turbidity, debris, and local visual checks, and stop at Blue Creek before the closed Mink Shoals boundary. |
| 1G | **Implemented:** Blue Creek DNR Access to Charleston Civic Center (`wv-elk-blue-creek-charleston`) | USGS 03197950, Elk River at Charleston | Official pages identify both public endpoints and cumulative mileages that derive a 13.8-mile pair. The generated trace is approximately 14.16 miles; finish by 6pm at the city dock, account for motorboat/barge traffic near the Kanawha confluence, and do not enter the navigation channel. |
...
9. **Implemented:** Wylo public access to Man public access (`wv-guyandotte-wylo-man`). Map 3 identifies this as Trip 9, a 5-mile reach at about 7 feet per mile; the Man station is retained as a same-river proxy because the published put-in is upstream of the gauge.
10. **Implemented:** Man public access to Earling public access (`wv-guyandotte-man-earling`). Map 3 identifies this as Trip 10, a 3.8-mile reach at about 5 feet per mile; the Man station is the direct start-of-reach gauge.
11. **Implemented:** Earling public access to Three Mile Curve (`wv-guyandotte-earling-three-mile-curve`). Map 3 identifies this as Trip 11, a 6.8-mile jon-boat-suitable reach; Logan is used as the same-river telemetry reference.
12. **Implemented:** Three Mile Curve to Four Seasons Country Store (`wv-guyandotte-three-mile-curve-four-seasons`). Map 3 identifies this as Trip 12, a 4.3-mile reach ending at a business-adjacent gravel ramp; permission and hours remain explicit gates.
13. **Implemented:** Four Seasons Country Store to Peach Creek (`wv-guyandotte-four-seasons-peach-creek`). Map 4 identifies this as Trip 13, a 1.8-mile access-chain reach; the business-adjacent start requires current permission confirmation.
14. **Implemented:** Peach Creek to Logan County Farmers Market (`wv-guyandotte-peach-creek-farmers-market`). Map 4 identifies this as Trip 14, a 6.8-mile reach ending at a concrete ramp off Old Logan Road.
15. **Implemented:** Logan County Farmers Market to Chapmanville (`wv-guyandotte-farmers-market-chapmanville`). Map 4 identifies this as Trip 15, a 3-mile reach ending at a canoe/kayak-sized boat slide under US 119.
16. **Implemented:** Chapmanville to Harts (`wv-guyandotte-chapmanville-harts`). Map 4 identifies this as Trip 16, a 12-mile mellow downstream reach ending at a concrete ramp near the Harts bridge.
17. **Implemented:** Harts to Branchland Park (`wv-guyandotte-harts-branchland`). Map 4 identifies this as Trip 17, a 21-mile reach too long for a single day; the card requires a Logan/Branchland gauge handoff and does not assume permission-based mid-reach exits.

Gate for the next Guyandotte batch: verify the nine Map 3/4 endpoint carries, private-business permissions, and generalized NHD offsets; do not add optional Trip 17 mid-reach exits until landowner permission and public-use terms are documented. Do not transfer the upper-river screens or the American Whitewater Simon–lake Class III warning without reach-specific calibration.

### Wave 8 — Lower Cacapon Water Trail

The WVDNR District 2 guide publishes a connected public chain from Route 127 through Cacapon Crossing and Fishers Ford to the Cacapon Power Plant, with 9-, 18-, and 8.5-mile distances. The Great Cacapon USGS station is downstream but provides a consistent stage proxy; the water-trail guide and Friends of the Cacapon both emphasize seasonal water levels, private banks, no public access-site camping, and careful cold-water planning.

1. **Implemented:** WV 127 Bridge to Cacapon Crossing (`wv-cacapon-rt127-cacapon-crossing`).
2. **Implemented:** Cacapon Crossing to Fishers Ford (`wv-cacapon-cacapon-crossing-fishers-ford`).
3. **Implemented:** Fishers Ford to Cacapon Power Plant (`wv-cacapon-fishers-ford-power-plant`), with the WVDNR-marked dam portage.

Gate for the next Cacapon batch: visually confirm the three public carries and the dam portage, then evaluate whether the long Cacapon Crossing–Fishers Ford reach should remain a single 18-mile card or be split only if a documented public/permission-based mid-access is found.
...
The next concrete batch is **Trip 17 access-permission and two-station validation plus lower-Cacapon visual carry checks**, not another unverified route card. Keep the Upper Falls portage boundary explicit for any Coal mainstem card. Keep Wave 1B (Sandy Beach to Clifton Ford) gated until the informal Sandy Beach endpoint is proven distinct and publicly usable; the Queen Shoals-to-Clendenin North gap is now covered by the verified 1D card, while Clendenin North–South remains deferred until its canonical channel trace is corrected (the current fallback measures 27.5 miles against the official 2.3-mile listing).
