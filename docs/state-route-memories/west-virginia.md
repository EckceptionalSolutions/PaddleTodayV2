...
- [`../west-virginia-route-research-plan.md`](../west-virginia-route-research-plan.md)
- [`../west-virginia-route-research-ledger.json`](../west-virginia-route-research-ledger.json)
...
- `03184500` New River at Hinton: `route_capable`.
- `03185400` New River at Thurmond: `route_capable`.
- `03179000` Bluestone River near Pipestem: `route_capable`, although the
  selected route remains operationally blocked.

Advancing candidates:

- Tug Creek River Access to Hellems Beach, 2.11 miles, Class II-III,
  Hinton gauge `1.35-5.0 ft`.
- Glade Creek River Access to Grandview Sandbar, 4.51 miles, Class II-III,
  Thurmond gauge `800-17,550 cfs`.
- McCreery River Access to Stone Cliff, 10.88 miles, Class II-III,
  Thurmond gauge `1.25-9.75 ft`.
- Cunard to Fayette Station, 6.84 miles, Class III-IV advanced/expert,
  Thurmond gauge `500-15,250 cfs` through AW's explicit secondary USGS
  correlation.

Blocked candidates:

- Thurmond to Cunard has a `7.2` versus `9.4` mile source conflict and an AW
  Class I-III versus NPS advanced/expert safety-framing conflict. The numeric
  threshold itself is qualified at `1.25-9.6 ft` on the Thurmond gauge.
- Pipestem Resort State Park to Bluestone State Park has the strongest official
  threshold in the batch: NPS says `4-7 ft` at the Pipestem gauge. It remains
  blocked because the replacement tram's official page confirms seasonal river
  access but does not say whether private canoes and kayaks are accepted as
  cargo.

Important route boundaries:

- Do not construct a New River route that crosses Sandstone Falls. NPS/AW treat
  it as a mandatory portage, with changing wood and mistaken descents in the
  source history.
- Do not present any New River route as ordinary flatwater. NPS describes the
  river as large and powerful; below Thurmond is advanced/expert water.
- Keep all Batch 1 candidates under the whitewater discovery filter.
- Current NPS closure information says Cunard Road is open through October with
  one-lane delays, then closed November-March while work continues.
