...
## Blackstone target completion — 2026-09-16

Added three distinct scored reaches from the Blackstone River Watershed Council access sequence: `blackstone-river-kelly-house-pratt`, `blackstone-river-pratt-central-falls`, and `blackstone-river-central-falls-chocolateville`. Kelly House, Pratt above and below-dam access, Central Falls Landing and Chocolateville are documented public water-entry or portage sites. The routes use the direct USGS 01112500 Woonsocket gauge and RiverScout’s 200–1,200 cfs Class I–II planning window. Every card preserves mandatory Pratt and Valley Falls portage boundaries, urban-current, water-quality, strainer and private-property warnings, water-entry verification and day-use camping guidance. The three route-specific gallery entries use the National Weather Service Blackstone at Pawtucket photograph as same-river context. Rhode Island now has 50 scored routes and meets the current target. Evidence: `docs/operations/starter-evidence/rhode-island-blackstone-2026-09.json`.
